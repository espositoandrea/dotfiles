...
- [[#basic-variables-and-configs][Basic Variables and Configs]]
  ...
  - [[#macos-specific-stuff][macOS specific stuff]]
- [[#org-mode][Org Mode]]
  ...
  - [[#custom-tood-states][Custom TOOD states]]
  - [[#system-wide-org-capture][System-Wide Org Capture]]
...
- [[#support-for-additional-languages][Support for Additional Languages]]
  - [[#pkl-httpspkl-langorg][Pkl (https://pkl-lang.org)]]
...
(map! :after org-mode
      :map org-mode-map
      :localleader
      :prefix ("O" . "delete property")

      :desc "Delete Org-Mode property"
      "e" #'org-delete-property)
#+end_src

** Gantt Charts
#+BEGIN_SRC elisp :tangle packages.el
(package! ox-taskjuggler
  :recipe (:host github :repo "h-oll/ox-taskjuggler"))
#+END_SRC
#+begin_src elisp
(use-package! ox-taskjuggler :after org)
#+end_src
...
I now define some custom capture templates, heavily inspired by [[https://vtimofeenko.com/posts/my-doom-emacs-setup/#capture-anything-that-crosses-your-mind-nothing-is-too-big-or-small][Vladimir Timofeenko's configuration]].
#+begin_src elisp
(after! org
    ; use add-to-list and 'org... to add instead of replace (remove one parenthesis)
    (setq org-capture-templates
        `(("t" "Task" entry (file+headline +org-capture-todo-file "Tasks")
         ,(string-join '("* TODO %?"
                         ":PROPERTIES:"
                         ":CREATED: %U"
                         ":END:")
                       "\n"))
        ("m" "Mail" entry (file+headline +org-capture-emails-file "Inbox")
            ,(string-join '("* TODO Mail: (%:fromname) %:subject :mail:"
                            "SCHEDULED:%t"
                            ":PROPERTIES:"
                            ":CREATED: %U"
                            ":END:"
        ...
        ("n" "Note" entry (file+headline +org-capture-notes-file "Inbox")
         ,(string-join '("* %?"
                         ...
                         ":END:")
                       "\n"))
        ("j" "Journal entry" entry (file+datetree +org-capture-journal-file)
         ,(string-join '("* %U\n%?"
                         ":PROPERTIES:"
                         ":CREATED: %U"
                         ":END:")
        ...
        ("M" "Meeting" entry (file+headline +org-capture-todo-file "Inbox")
         ,(string-join '("* %? :meeting:"
                         ...
                         "/Met with: /")
                       "\n"))
        ("a" "Appointment" entry (file+headline +org-capture-todo-file "Inbox")
...
#+begin_src elisp :tangle packages.el
(package! pkl-mode
    :recipe (:host github :repo "sin-ack/pkl-mode"))
#+end_src
